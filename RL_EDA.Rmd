...
mp = read_csv("https://github.com/Derek-Kirk/Rocket_League/blob/cd8b6dbbf3577b8280e1d32b914d24f25a799784/matches_by_players.csv") #Matches at the player level
#mp$scored_core_goal = ifelse(mp$core_goals > 0, 1, 0)

mt = read_csv("https://github.com/Derek-Kirk/Rocket_League/blob/cd8b6dbbf3577b8280e1d32b914d24f25a799784/matches_by_teams.csv") #Matches at the team level
...
temp = sqldf("select player_tag, count(player_tag) as player_count from joined_data
      where (1=1)
      group by player_tag 
      order by player_count DESC
      limit 100")
